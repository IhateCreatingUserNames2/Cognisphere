...
def register_memory_tools_with_aira():
    ...
    try:
        ...
        from cognisphere_adk.tools.memory_tools import recall_memories, create_memory
    except ImportError:
        try:
            # Try without the cognisphere_adk prefix
            from tools.memory_tools import recall_memories, create_memory
        except ImportError:
            # Last resort, try with a sys.path modification
            import sys
            import os
...
def register_narrative_tools_with_aira():
    ...
    try:
        # Try the direct import first
        from cognisphere_adk.tools.narrative_tools import (
...
def register_emotion_tools_with_aira():
    ...
    try:
        # Try the direct import first
        from cognisphere_adk.tools.emotion_tools import analyze_emotion
    except ImportError:
        try:
            # Try without the cognisphere_adk prefix
